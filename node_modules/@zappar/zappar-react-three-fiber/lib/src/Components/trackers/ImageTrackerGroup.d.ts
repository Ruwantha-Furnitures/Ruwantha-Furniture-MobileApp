 ...
 */
declare const ZapparImageTracker: React.ForwardRefExoticComponent<Pick<Omit<import("@react-three/fiber").Node<Omit<ZapparThree.ImageAnchorGroup, "imageTracker">, typeof ZapparThree.ImageAnchorGroup>, import("@react-three/fiber").NonFunctionKeys<{
