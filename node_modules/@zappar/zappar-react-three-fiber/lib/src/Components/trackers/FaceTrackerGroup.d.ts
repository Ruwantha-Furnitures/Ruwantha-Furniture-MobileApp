 ...
 */
declare const ZapparFaceAnchorGroup: React.ForwardRefExoticComponent<Pick<Omit<import("@react-three/fiber").Node<Omit<ZapparThree.FaceAnchorGroup, "faceTracker">, typeof ZapparThree.FaceAnchorGroup>, import("@react-three/fiber").NonFunctionKeys<{
