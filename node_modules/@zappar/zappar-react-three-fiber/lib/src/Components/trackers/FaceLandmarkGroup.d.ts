 ...
 */
declare const zapparFaceLandmark: React.ForwardRefExoticComponent<Pick<Omit<import("@react-three/fiber").Node<ZapparThree.FaceLandmarkGroup, typeof ZapparThree.FaceLandmarkGroup>, import("@react-three/fiber").NonFunctionKeys<{
