 ...
 */
declare const ZapparInstantTracker: React.ForwardRefExoticComponent<Pick<Omit<import("@react-three/fiber").Node<Omit<ZapparThree.InstantWorldAnchorGroup, "instantTracker">, typeof ZapparThree.InstantWorldAnchorGroup>, import("@react-three/fiber").NonFunctionKeys<{
