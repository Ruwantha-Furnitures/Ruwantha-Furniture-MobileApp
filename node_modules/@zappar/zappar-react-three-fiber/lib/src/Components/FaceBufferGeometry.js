...
fiber_1.extend({ FaceBufferGeometry });
/**
 ...
 */
const ZapparFaceBufferGeometry = react_1.forwardRef((props, ref) => {
    ...
    const [faceMesh, setFaceMesh] = react_1.useState();
    react_1.useEffect(() => {
        if (fullHead) {
    ...
    if (!faceMesh)
        return null;
    return (react_1.default.createElement("faceBufferGeometry", Object.assign({ args: [faceMesh], ref: react_merge_refs_1.default([faceBufferGeometryRef, ref]) }, props), children));
});
