 ...
 */
declare const zapparHeadMaskMesh: React.ForwardRefExoticComponent<Pick<Omit<import("@react-three/fiber").Node<import("three").Mesh<import("three").BufferGeometry, import("three").Material | import("three").Material[]>, typeof import("three").Mesh>, import("@react-three/fiber").NonFunctionKeys<{
